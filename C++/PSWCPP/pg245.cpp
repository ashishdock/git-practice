...
// Returns the price per square inch of a pizza. The formal parameter named diameter is the diameter of the pizza in inches. The formal parameter named price is the price of the pizza.
