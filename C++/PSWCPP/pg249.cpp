...
// Returns an estimate of the total number of peas harvested. The formal parameter pod_count is the number of pods.
// The formal parameters min_peas and max_peas are the minimum and maximum number of peas in a pod.
...
int main()
{
	...
	cout.precision(3);
	cout << "Min number of peas per pod = " << min_count << endl << "Max number of peas per pod = " << max_count << endl << "Pod count = " << pod_count << endl << "Average pea weight = " << average_pea << " ounces " << endl << "Estimated average yield = " << yield << " ounces " << endl;
