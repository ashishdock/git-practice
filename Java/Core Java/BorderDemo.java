...
class BorderDemo extends JFrame
{
	...
	BorderDemo()
	{
		...
		//set raised bevel border for b1 with highlight color: red and shadow color: green
		...
		//set raised Etched border for b3 with highlight color: red and shadow color: green
