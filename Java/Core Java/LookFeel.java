...
class LookFeel extends JFrame implements ItemListener
{
	...
	LookFeel()
	{
		...
		//create ButtonGroup object and add Radiobuttons to specify
		bg = new ButtonGroup();
		bg.add(r1);
		bg.add(r2);
		bg.add(r3);
	...
	public void itemStateChanged(ItemEvent ie)
	{
		try
		{
			//know which radio button is pressed and accordingly change the look and feel
	...
	{
		//create the frame
		LookFeel f = new LookFeel();
		
		f.setSize(800,600);
		f.setTitle("Look and Feel");
		f.setVisible(true);
	}
}