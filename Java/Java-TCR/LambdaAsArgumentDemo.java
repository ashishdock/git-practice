...
class LambdaAsArgumentDemo
{
	...
	public static void main(String args[])
	{
		...
		// Of course, it is also possible to pass a StringFunc instance created by an earlier lambda expression. For example, after this declaration executes, reverse refers
