...
// A ForkJoinTask (via RecursiveAction) that transforms the elements in an array of doubles into their square roots.
...
class ForkJoinDemo
{
	public static void main(String args[])
	{
		...
		System.out.println("A portion of the transformed sequence" + " (to four decimal place): ");
		for(int i=0; i<10; i++)
