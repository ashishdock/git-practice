// Use an instance method reference with different ojects.
...
{
	// A method that returns the number of occurences of an object for which some criteria, as specified by the MyFunc parameter, is true.
