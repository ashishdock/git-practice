// A simple demonstration of local variable type reference.
...
class VarDemo
{
	public static void main(String args[])
	{
		...
		//Interestingly, in the following sequence, var is used as both the type of the declaration and as a variable name in the initializer.
		var k = -var;
