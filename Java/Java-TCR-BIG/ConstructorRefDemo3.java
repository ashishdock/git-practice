...
class MyClass2
{
	...
	// The default constructor. This contructor is NOT used by this program.
	MyClass2()
	{
		str = "";
	}
...
{
	// A factory method for class objects. The class must have a constructor that takes one parameter of type T. R specifies the type of object being created.
	...
	{
		// Create a reference to a MyClass constructor. In this case, new refers to the constructor that takes an argument.
